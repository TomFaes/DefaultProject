...
<div role="dialog" aria-labelledby="lcc-modal-alert-label" aria-describedby="lcc-modal-alert-desc" aria-modal="true" class="lcc-modal lcc-modal--alert js-lcc-modal js-lcc-modal-alert" style="display: none; border-radius: 15px;"
...
>
    ...
    <div class="lcc-modal__actions">
        <button type="button" class="js-lcc-accept btn btn-primary btn-block fa-lg color-style mb-3">
...
<div role="dialog" aria-labelledby="lcc-modal-settings-label" aria-describedby="lcc-modal-settings-desc" aria-modal="true" class="lcc-modal lcc-modal--settings js-lcc-modal js-lcc-modal-settings" style="display: none; border-radius: 15px;">
    ...
    <div class="lcc-modal__content">
        <div class="lcc-modal__content">
            ...
            <div class="lcc-modal__section lcc-u-text-center">
                <button type="button" class="js-lcc-accept btn btn btn-primary btn-block fa-lg color-style mb-3">
                    @lang('cookie-consent::texts.settings_accept_all')
                </button>
            </div>
            <div class="lcc-modal__section form-check form-switch">
                <label for="lcc-checkbox-essential" class="lcc-label">
                    <input role="switch" class="form-check-input" type="checkbox" id="lcc-checkbox-essential" disabled="disabled" checked="checked">
            ...
            <div class="lcc-modal__section form-check form-switch">
                <label for="lcc-checkbox-funtcional" class="lcc-label">
                    <input role="switch" class="form-check-input" type="checkbox" id="lcc-checkbox-funtcional" disabled="disabled" checked="checked">
            ...
            <div class="lcc-modal__section form-check form-switch">
                <label for="lcc-checkbox-analytics" class="lcc-label">
                    <input role="switch" class="form-check-input" type="checkbox" id="lcc-checkbox-analytics">
            ...
            <div class="lcc-modal__section form-check form-switch">
                <label for="lcc-checkbox-marketing" class="lcc-label">
                    <input role="switch" class="form-check-input" type="checkbox" id="lcc-checkbox-marketing">
    ...
    <div class="lcc-modal__actions">
        <button type="button" class="js-lcc-settings-save btn btn-primary btn-block fa-lg color-style mb-3">
            @lang('cookie-consent::texts.settings_save')
        </button>
    </div>
</div>
<div class="lcc-backdrop js-lcc-backdrop" style="display: none;"></div>
<script defer type="text/javascript" src="{{ asset("vendor/cookie-consent/js/cookie-consent.js") }}"></script>